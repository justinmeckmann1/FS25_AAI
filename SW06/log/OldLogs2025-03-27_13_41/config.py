...
# Select Usecase
USECASE = "MNIST"  # MNIST | CIFAR --> für arbeit CIFAR
...
if USECASE == "CIFAR":
    ...
    ##### Ranking parameters #########################################################
    # 2D-Gaussian function parameters (used with metric "macs_and_acc")
    mu_acc    = 0          # expected value accuracy [%]                             # <---- ToDo
    sigma_acc = 0          # standard deviation accuracy [%]                         # <---- ToDo
    mu_mac    = 0*10**6    # expected value # of MACs                                # <---- ToDo
    sigma_mac = 0*10**6    # standard deviation # of MACs                            # <---- ToDo
