...
if USECASE == "CIFAR":
    ...
    max_mac            = 50*10**6                                                       # <---- ToDo
    max_param          = 5*10**6                                                       # <---- ToDo
    acc_lim_init       = 0.90                                                         # <---- ToDo
    acc_lim_step_time  = 1      # default 1
    acc_lim_step_hight = 0.01   # default 0.01

    ##### Evolution parameters #######################################################
    pop_size                   = 1 #10
    nbr_of_evo_rounds          = 0 #4
    nbr_of_parents             = 2 
    ...
    sigma_acc = 1          # standard deviation accuracy [%]                        # <---- ToDo
    mu_mac    = 45*10**6  # expected value # of MACs                               # <---- ToDo
    sigma_mac = 10*10**6  # standard deviation # of MACs                           # <---- ToDo
